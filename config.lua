...
Config.DescriptionDistance = 3.0
...
Config.MaximumScenesPerPlayer = 5
Config.MaximumScenesByDiscordRole = {
    ["PatreonChung"] = 9,
    ["PatreonKahlo"] = 8,
    ["PatreonEleanor"] = 7,
}

Config.MaximumExpirationInHours = 24
Config.MaximumExpirationInHoursByDiscordRole = {
    ["PatreonChung"] = 72,
    ["PatreonKahlo"] = 48,
    ["PatreonEleanor"] = 24,
}
...
Config.HotKeys = {
    -- Scene = 0xE6F612E4, -- 1
    Place = 0xE6F612E4 -- 1 -- "Place Scene"
}

Config.Prompts = {
    EditAppearance = {[1] = "Edit Scene Appearance", [2] = 0x1CE6D9EB}, -- 2 -- "Edit Scene Appearance"
	EditDescription = {[1] = "Edit Scene Description", [2] = 0x4F49CC4C}, -- 3 -- "Edit Scene Description"
    Place = {
        title = 'Place Scene'
    }
}
...
Config.Texts = {
    AddDetails = "Set Scene Title Text",
